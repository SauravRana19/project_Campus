      ...
      <div class="col-4 mt-3">
        <div class="card">
          <div class="card-body text-center">
            ...
            />
            <h2>Welcome <br />{{ data.fullname }}</h2>
            <h5 style="font-size: 2vw"></h5>
          </div>
        </div>
      </div>
      <div class="col-8">
        <div class="card" style="margin-top: 5px">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0 capitalize">
                  {{ data.fullname }}
                </p>
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    function updateData(id) {
      store.state.fullname = data.value.fullname;
      store.state.email = data.value.email;
      store.state.password = data.value.password;
      store.dispatch("updateData", id);
    }
    function Dell(id) {
